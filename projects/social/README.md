...
1. To create 100 users with an average of 10 friends each, how many times would you need to call `add_friendship()`? Why?
    ...
    I would need to call  `add_friendship()` 500 times because 100*10 = 1000 but friendship is a pair and you friend automatically adds you when you add your friend which half the 1000.
